...
# TODO what is mode is available but not active? I.e. 4K in Full HD mode. Check if possible to get active without xrandr
...
logger "$0 system font scaling factor was set to $SCALE_FACTOR"
